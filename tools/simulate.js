...
/* ---------------------- 载入模块 ---------------------- */
const files = ['runtime', 'util', 'audio', 'config', 'grid', 'fx', 'enemies',
...
/* ---------------------- 简易 AI ---------------------- */
/* 一座「理想玩家」会摆出的阵地：雷引竖链 + 寒霜贴边吃超导 + 赤炎群 */
const PLAN = [
  // 雷引竖链（同元素 → 长共振链）
...
const WALL = [[0, 6, 'pyro'], [1, 6, 'pyro'], [2, 6, 'pyro'], [3, 6, 'cryo'],
[6, 6, 'cryo'], [7, 6, 'cryo'], [8, 6, 'electro'], [9, 6, 'electro']];
